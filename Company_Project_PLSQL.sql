...
--
ALTER PLUGGABLE DATABASE Panos_Chron SAVE STATE;
--
SELECT Name, Open_Mode FROM V$Pdbs;
--
...
ALTER SESSION SET CONTAINER = Panos_Chron;
--
CREATE INDEX EmployeeMiddleName_INDX ON Employees(EmployeeMiddleName);
CREATE BITMAP INDEX EmployeeSex_EmployeeFamilySituation_INDX ON Employees(EmployeeSex, EmployeeFamilySituation);
CREATE INDEX EmployeeSpeciality_EmployeeExperience_INDX ON Employees(UPPER(EmployeeSpeciality), UPPER(EmployeeExperience));
CREATE INDEX EmployeeSalary_EmployeeYearOfRecruitment_INDX ON Employees(EmployeeSalary, EmployeeYearOfRecruitment);
--
CREATE OR REPLACE PACKAGE Panos_Chron_Package IS
FUNCTION ReturnedEmployeeSalary
RETURN NUMBER;
PROCEDURE EmployeeSalary1;
PROCEDURE EmployeeSalary2(GivenEmployeeID NUMBER);
PROCEDURE EmployeeSumSalary;
PROCEDURE EmployeeSalary3;
PROCEDURE EmployeeSalary4;
PROCEDURE EmployeeSalary5;
PROCEDURE EmployeeSalary6;
PROCEDURE EmployeeSalary7;
PROCEDURE IndexStatements;
END;
--
-- STOP EXECUTING
--
CREATE OR REPLACE PACKAGE BODY Panos_Chron_Package IS
FUNCTION ReturnedEmployeeSalary
RETURN NUMBER
IS
ReturnedSalary NUMBER(7,2);
BEGIN
SELECT EmployeeSalary INTO ReturnedSalary FROM Employees WHERE EmployeeID = &GivenEmployeeID;
RETURN ReturnedSalary;
END;
--
PROCEDURE EmployeeSalary1 IS
TYPE Record1 IS TABLE OF Employees%ROWTYPE INDEX BY PLS_INTEGER;
Record2 Record1;
CURSOR Cursor1 IS SELECT * FROM Employees;
BEGIN
OPEN Cursor1;
FETCH Cursor1 BULK COLLECT INTO Record2;
FOR I IN Record2.FIRST..Record2.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('First Name : ' || Record2(i).EmployeeFirstName || ', Last Name : ' || Record2(i).EmployeeLastName || ', Salary : ' || Record2(i).EmployeeSalary);
END LOOP;
CLOSE Cursor1;
END;
--
PROCEDURE EmployeeSalary2(GivenEmployeeID NUMBER) IS
TYPE Record3 IS TABLE OF Employees%ROWTYPE INDEX BY PLS_INTEGER;
Record4 Record3;
BEGIN
EXECUTE IMMEDIATE 'SELECT * FROM Employees WHERE EmployeeID = :GivenEmployeeID' BULK COLLECT INTO Record4 USING (GivenEmployeeID);
FOR I IN Record4.FIRST..Record4.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('First Name : ' || Record4(i).EmployeeFirstName || ', Last Name : ' || Record4(i).EmployeeLastName || ', Salary : ' || Record4(i).EmployeeSalary);
END LOOP;
END;
--
PROCEDURE EmployeeSumSalary IS
Record5 NUMBER(7,2);
BEGIN
SELECT SUM(EmployeeSalary) INTO Record5 FROM Employees WHERE EmployeeID BETWEEN &GivenStartEmployeeID AND &GivenEndEmployeeID;
DBMS_OUTPUT.PUT_LINE('Total Salary Of Employees is : ' || Record5);
END;
--
PROCEDURE EmployeeSalary3 IS
Record6 Employees.EmployeeSalary%type;
BEGIN
SELECT EmployeeSalary INTO Record6 FROM Employees WHERE EmployeeID = &GivenEmployeeID;
DBMS_OUTPUT.PUT_LINE('Employee Salary is : ' || Record6);
END;
--
PROCEDURE EmployeeSalary4 IS
Record7 Employees%ROWTYPE;
BEGIN
SELECT * INTO Record7 FROM Employees WHERE EmployeeID = &GivenEmployeeID;
DBMS_OUTPUT.PUT_LINE('Employee Salary is : ' || Record7.EmployeeSalary);
END;
--
PROCEDURE EmployeeSalary5 IS
TYPE Record8 IS TABLE OF Employees%ROWTYPE INDEX BY PLS_INTEGER;
Record9 Record8;
BEGIN
SELECT * BULK COLLECT INTO Record9 FROM Employees;
FOR I IN Record9.FIRST..Record9.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('Employee Salary is : ' || Record9(i).EmployeeSalary);
END LOOP;
END;
--
PROCEDURE EmployeeSalary6 IS
TYPE Record10 IS TABLE OF Employees.EmployeeSalary%TYPE INDEX BY PLS_INTEGER;
Record11 Record10;
BEGIN
SELECT EmployeeSalary BULK COLLECT INTO Record11 FROM Employees;
FOR I IN Record11.FIRST..Record11.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('Employee Salary is : ' || Record11(i));
END LOOP;
END;
--
PROCEDURE EmployeeSalary7 IS
TYPE Record12 IS RECORD (EmployeeSalaryPanos_Chron Employees.EmployeeSalary%type);
Record13 Record12;
TYPE Record14 IS TABLE OF Record12 INDEX BY PLS_INTEGER;
Record15 Record14;
BEGIN
SELECT EmployeeSalary INTO Record13 FROM Employees WHERE EmployeeID = &GivenEmployeeID;
DBMS_OUTPUT.PUT_LINE('Employee Salary is : ' || Record13.EmployeeSalaryPanos_Chron);
DBMS_OUTPUT.PUT_LINE('--');
SELECT EmployeeSalary BULK COLLECT INTO Record15 FROM Employees;
FOR I IN Record15.FIRST..Record15.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('Employee Salary is : ' || Record15(i).EmployeeSalaryPanos_Chron);
END LOOP;
END;
--
PROCEDURE IndexStatements IS
TYPE Record16 IS RECORD (EmployeeFirstNamePanos_Chron Employees.EmployeeFirstName%type, EmployeeLastNamePanos_Chron Employees.EmployeeLastName%type, EmployeeSalaryPanos_Chron Employees.EmployeeSalary%type);
TYPE Record17 IS TABLE OF Record16 INDEX BY PLS_INTEGER;
Record18 Record17;
Record19 Record17;
Record20 Record17;
Record21 Record17;
BEGIN
EXECUTE IMMEDIATE 'SELECT EmployeeFirstName, EmployeeLastName, EmployeeSalary FROM Employees WHERE EmployeeMiddleName > ''&GiveALetter.''' BULK COLLECT INTO Record18;
FOR I IN Record18.FIRST..Record18.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('Employee First Name is : ' || Record18(i).EmployeeFirstNamePanos_Chron || ', Employee Last Name is : ' || Record18(i).EmployeeLastNamePanos_Chron || ', Employee Salary is : ' || Record18(i).EmployeeSalaryPanos_Chron);
END LOOP;
DBMS_OUTPUT.PUT_LINE('--');
EXECUTE IMMEDIATE 'SELECT EmployeeFirstName, EmployeeLastName, EmployeeSalary FROM Employees WHERE EmployeeSex = ''&GiveEmployeeSex'' AND  EmployeeFamilySituation = ''&GiveEmployeeFamilySituation''' BULK COLLECT INTO Record19;
FOR I IN Record19.FIRST..Record19.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('Employee First Name is : ' || Record19(i).EmployeeFirstNamePanos_Chron || ', Employee Last Name is : ' || Record19(i).EmployeeLastNamePanos_Chron || ', Employee Salary is : ' || Record19(i).EmployeeSalaryPanos_Chron);
END LOOP;
DBMS_OUTPUT.PUT_LINE('--');
EXECUTE IMMEDIATE 'SELECT EmployeeFirstName, EmployeeLastName, EmployeeSalary FROM Employees WHERE EmployeeSpeciality = ''&GiveEmployeeSpeciality'' AND  EmployeeExperience = ''&GiveEmployeeExperience''' BULK COLLECT INTO Record20;
FOR I IN Record20.FIRST..Record20.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('Employee First Name is : ' || Record20(i).EmployeeFirstNamePanos_Chron || ', Employee Last Name is : ' || Record20(i).EmployeeLastNamePanos_Chron || ', Employee Salary is : ' || Record20(i).EmployeeSalaryPanos_Chron);
END LOOP;
DBMS_OUTPUT.PUT_LINE('--');
EXECUTE IMMEDIATE 'SELECT EmployeeFirstName, EmployeeLastName, EmployeeSalary FROM Employees WHERE EmployeeYearOfRecruitment > ''&GiveStartEmployeeYearOfRecruitment'' AND EmployeeYearOfRecruitment < ''&GiveEndEmployeeYearOfRecruitment''' BULK COLLECT INTO Record21; -- 01/01/2021, --01/01/2023
FOR I IN Record21.FIRST..Record21.LAST
LOOP
DBMS_OUTPUT.PUT_LINE('Employee First Name is : ' || Record21(i).EmployeeFirstNamePanos_Chron || ', Employee Last Name is : ' || Record21(i).EmployeeLastNamePanos_Chron || ', Employee Salary is : ' || Record21(i).EmployeeSalaryPanos_Chron);
END LOOP;
EXCEPTION
...
-- STOP EXECUTING
--
EXECUTE DBMS_OUTPUT.PUT_LINE(Panos_Chron_Package.ReturnedEmployeeSalary);
--
DECLARE ReturnedSalary NUMBER(7,2);
BEGIN
ReturnedSalary := Panos_Chron_Package.ReturnedEmployeeSalary;
DBMS_OUTPUT.PUT_LINE('Employee Salary is : ' || ReturnedSalary);
END;
--
EXECUTE Panos_Chron_Package.EmployeeSalary1;
--
EXECUTE Panos_Chron_Package.EmployeeSalary2(3);
--
EXECUTE Panos_Chron_Package.EmployeeSumSalary;
--
EXECUTE Panos_Chron_Package.EmployeeSalary3;
--
EXECUTE Panos_Chron_Package.EmployeeSalary4;
--
EXECUTE Panos_Chron_Package.EmployeeSalary5;
--
EXECUTE Panos_Chron_Package.EmployeeSalary6;
--
EXECUTE Panos_Chron_Package.EmployeeSalary7;
--
EXECUTE Panos_Chron_Package.IndexStatements;
--
------------------------------
------------------------------
------------------------------
...
ALTER SESSION SET CONTAINER = Panos_Chron;
--
DROP PACKAGE BODY IF EXISTS Panos_Chron_Package;
--
DROP PACKAGE IF EXISTS Panos_Chron_Package;
--
DROP INDEX IF EXISTS EmployeeSalary_EmployeeYearOfRecruitment_INDX;
--
DROP INDEX IF EXISTS EmployeeSpeciality_EmployeeExperience_INDX;
--
DROP INDEX IF EXISTS EmployeeSex_EmployeeFamilySituation_INDX;
--
